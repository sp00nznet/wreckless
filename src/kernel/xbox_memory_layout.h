 ...
 *
 *   0x00011000 - 0x000F8760  .text (code)       ~947 KB
 *   0x000F8760 - 0x0014EF1C  XDK library code   (D3D, D3DX, XGRPH, DSOUND, WMVDEC, XPP)
 *   0x0014EF20 - 0x00154FF4  .rdata (constants) ~24 KB
 *   0x00155000 - 0x001D1E0C  .data + BSS        ~500 KB
 *
...
#ifndef WRECKLESS_XBOX_MEMORY_LAYOUT_H
#define WRECKLESS_XBOX_MEMORY_LAYOUT_H
...
#define XBOX_TEXT_SIZE          948064      /* 0x000E7760 */

/* .rdata section */
#define XBOX_RDATA_VA           0x0014EF20
#define XBOX_RDATA_SIZE         24788       /* 0x000060D4 */

/* .data section (includes BSS) */
#define XBOX_DATA_VA            0x00155000
#define XBOX_DATA_SIZE          511500      /* 0x0007CE0C */
#define XBOX_DATA_INIT_SIZE     20120       /* 0x00004E98 - Initialized data in XBE file */
 ...
 *
 * Reserves the virtual address range 0x00010000 through 0x001D1E0C
...
#endif /* WRECKLESS_XBOX_MEMORY_LAYOUT_H */
