...
/*
 * The thunk table is a 113-entry array of function pointers at VA 0x0014EF20.
 * Game code calls kernel functions via: call [thunk_addr]
 * We fill this table at startup with our xbox_* implementations.
 */
#define XBOX_KERNEL_THUNK_TABLE_BASE  0x0014EF20
#define XBOX_KERNEL_THUNK_TABLE_SIZE  113
